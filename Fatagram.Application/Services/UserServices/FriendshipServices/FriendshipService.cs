...
namespace Fatagram.Application.Services.UserServices.FriendshipServices
{
    public class FriendshipService : IFriendshipService
    {
        ...
        )
        {
            ...
            if (friendship != null)
                return Result<GetFriendShipStatusDto>.Success(
        ...
        public async Task<Result<int>> GetNumberOfFriendsAsync(Guid userId)
        {
            ...
            return Result<int>.Success(ResponseStatusCode.Success, count);
        }
        ...
        )
        {
            ...
            return PagedResult<FriendRequestDto>.Success(friendRequests, data.total);
        }
        ...
        )
        {
            ...
            return PagedResult<FriendDto>.Success(friends, data.total);
        }
    }
}
