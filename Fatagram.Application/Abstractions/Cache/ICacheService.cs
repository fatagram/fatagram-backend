...
namespace Fatagram.Application.Abstractions.Cache
{
    /// <summary>
    ...
    public interface ICacheService
    {
        ...
        // Phù hợp lưu: Profile User, Token, hoặc các Flag đơn giản.
        // ==========================================
        ...
        /// <summary> Xóa các phần tử trong khoảng rank (0-indexed). Dùng để trim hot window. </summary>
        Task<long> SortedSetRemoveRangeByRankAsync(string key, long start, long stop);

        /// <summary> Đếm số phần tử trong Sorted Set. </summary>
