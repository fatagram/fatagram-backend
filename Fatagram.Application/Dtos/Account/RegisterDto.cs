...
namespace Fatagram.Application.Dtos.Account
{
    ...
    public class RegisterDto
    {
        ...
        /// </summary>
        [RegularExpression(RegexPatterns.Username, ErrorMessage = ErrorCodes.USERNAME_NOT_CORRECT_FORMAT)]
        ...
        /// </summary>
        [RegularExpression(RegexPatterns.Password, ErrorMessage = ErrorCodes.PASSWORD_NOT_CORRECT_FORMAT)]
