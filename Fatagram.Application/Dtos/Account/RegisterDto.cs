...
namespace Fatagram.Application.Dtos.Account
{
    ...
    public class RegisterDto
    {
        ...
        [RegularExpression(
            ...
            ErrorMessage = ErrorCodes.USERNAME_NOT_CORRECT_FORMAT
        )]
        ...
        [RegularExpression(
            ...
            ErrorMessage = ErrorCodes.PASSWORD_NOT_CORRECT_FORMAT
        )]
        ...
        [RegularExpression(
            ...
            ErrorMessage = ErrorCodes.FIRSTNAME_NOT_CORRECT_FORMAT
        )]
        ...
        /// </summary>
        [RegularExpression(
            RegexPatterns.LastName,
            ErrorMessage = ErrorCodes.LASTNAME_NOT_CORRECT_FORMAT
        )]
        ...
        [RegularExpression(
            RegexPatterns.Phone,
            ErrorMessage = ErrorCodes.PHONE_NUMBER_NOT_CORRECT_FORMAT
        )]
